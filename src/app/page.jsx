...
const COPY = {
  en: {
    ...
    explore: "Explore",
    offerings: [
      { title: "Services", desc: "Hair Cuts,hair colour, styling & treatments by our expert team." },
    ...
    featNew: "New",
    featTitle: "Dress,Jewelry & Shoes, made for the occasion",
    featDesc: "Rent elegant dresses,dazzling jewelry and shoes for weddings, parties, and every celebration. Browse available pieces, pick your dates, and reserve online — effortlessly.",
  ...
  si: {
    ...
    heroSub: "උසස් සැලෝන් සේවා, විශේෂ පැකේජ, සහ ඇඳුම් හා ආභරණ කුලියට — සියල්ල අන්තර්ජාලය ඔස්සේ වෙන්කරගත හැකි එකම ස්ථානය.",
    book: "වේලාවක් වෙන්කරන්න",
    dress: "ඇඳුම් සහ ආභරණ",
    offerEyebrow: "අපගේ සේවාවන්",
    offerTitle: "ඔබට අවශ්‍ය සියල්ල, එකම තැනක",
    explore: "බලන්න",
    offerings: [
      { title: "සේවා", desc: "කොන්ඩා කැපීම්, වර්ණ ගැන්වීම්, ස්ටයිලින් සහ ප්‍රතිකාර — අපගේ ප්‍රවීණ කණ්ඩායම විසින්." },
      { title: "පැකේජ", desc: "මනාලියන් සදහා සුවිශේෂ පැකේජ." },
      { title: "නිෂ්පාදන", desc: "අපගේ උසස් තත්වයේ නිශ්පාදන." },
      { title: "ඇඳුම් සහ ආභරණ", desc: "ඔබේ විශේෂ දිනය සඳහා ලස්සන ඇඳුම්,ආභරණ සහ පාවහන් කුලියට." },
      { title: "ගැලරිය", desc: "අපගේ නවතම වැඩ සහ සතුටු පාරිභෝගිකයින්." },
      { title: "ඔබගේ වෙන්කිරීම්", desc: "ඔබ අපගෙන් කරන ලද සියලුම booking සහ order මෙම ස්තානයෙන් බලන්න,ඔබගේ වෙන්කිරීම් එකම තැනකින් කළමනාකරණය කරන්න." },
    ],
    featNew: "අලුත්",
    featTitle: "ඇඳුම්,ආභරණ සහ පාවහන් විශේෂ අවස්ථා සඳහා",
    ...
    whyTitle: "සෑම පැමිණීමකදීම සුඛෝපභෝගීත්වයක්",
    why: [
      { title: "ප්‍රවීණ රූපලාවන්‍ය ශිල්පීන්", desc: "නවතම විලාසිතා දන්නා දක්ෂ කණ්ඩායමක්." },
      ...
      { title: "සුහදශීලී සේවාව", desc: "ඔබට ඇති ඕනෑම රූපලාවන්‍ය ගැටලුවක් අප සමග සාකච්ඡා කරන්න." },
    ],
    ctaTitle: "නව පෙනුමක් සඳහා සූදානම්ද?",
    ctaSub: "ඔබේ වේලාව වෙන්කරන්න හෝ විශේෂ අවස්ථාවක් සඳහා පෙනුමක් තප්පර කිහිපයකින් වෙන්කරගන්න.",
